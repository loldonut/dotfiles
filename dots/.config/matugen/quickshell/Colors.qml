...
Singleton {
  ...
  property string uponPrimaryContainer:     "{{ colors.on_primary_container.default.hex }}"
  property string inversePrimary:           "{{ colors.inverse_primary.default.hex }}"
  property string secondary:                "{{ colors.secondary.default.hex }}"
  property string uponSecondary:            "{{ colors.on_secondary.default.hex }}"
  property string onSecondaryFixed:         "{{ colors.on_secondary_fixed.default.hex }}"
  property string uponSecondaryContainer:   "{{ colors.on_secondary_container.default.hex }}"
  property string tertiary:                 "{{ colors.tertiary.default.hex }}"
  property string uponTertiary:             "{{ colors.on_tertiary.default.hex }}"
  property string uponTertiaryContainer:    "{{ colors.on_tertiary_container.default.hex }}"
  property string error:                    "{{ colors.error.default.hex }}"
  property string uponError:                "{{ colors.on_error.default.hex }}"
  property string bg:                       "{{ colors.surface.default.hex }}"
  property string uponSurface:              "{{ colors.on_surface.default.hex }}"
  property string surfaceVariant:           "{{ colors.surface_variant.default.hex }}"
  property string uponSurfaceVariant:       "{{ colors.on_surface_variant.default.hex }}"
  ...
  property string uponBackground:           "{{ colors.on_background.default.hex }}"
