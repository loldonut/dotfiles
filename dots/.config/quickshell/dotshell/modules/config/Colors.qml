...
Singleton {
  ...
  property string uponTertiaryContainer:    "#fbd7fc"
  property string error:                    "#ffb4ab"
  property string uponError:                "#690005"
  property string bg:                       "#111318"
  property string uponSurface:              "#e2e2e9"
  property string surfaceVariant:           "#44474f"
  property string uponSurfaceVariant:       "#c4c6d0"
  property string outline:                  "#8e9099"
  property string outlineVariant:           "#44474f"
  property string background:               "#111318"
  property string uponBackground:           "#e2e2e9"
